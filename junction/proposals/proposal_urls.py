...
from .views import (create_proposal, delete_proposal, detail_proposal,
                    list_proposals, update_proposal, review_proposal)
...
urlpatterns = patterns(
    ...
    url(r'^review/(?P<slug>[\w-]+)/$', review_proposal, name='proposal-review'),
)
